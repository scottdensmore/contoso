...
// is configured via `srcsetCeiling` (falling back to `maxDimension`).
// Using `srcsetCeiling` decouples Next.js deviceSizes derivation from the
// catalogue asset guard, allowing future high-resolution full-bleed backgrounds
// (e.g. 2048px) without forcing an unneeded expansion of the catalogue srcset ladder.
//
...
const sourceWidth = catalogueImages.srcsetCeiling ?? catalogueImages.maxDimension
const deviceSizes = [
