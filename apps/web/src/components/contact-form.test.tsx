...
describe('ContactForm', () => {
  ...
  it('renders all form fields', () => {
    ...
    const orderNumberInput = screen.getByLabelText(/order number \(optional\)/i)
    expect(orderNumberInput).toBeDefined()
    expect(orderNumberInput).not.toHaveAttribute('placeholder')
