import { type AlpineScubaGearItem } from '@/lib/alpine-scuba';

interface AlpineScubaChecklistProps {
  gearItems: AlpineScubaGearItem[];
  checkedGear: Record<string, boolean>;
  onToggleGear: (id: string) => void;
}

export default function AlpineScubaChecklist({
  gearItems,
  checkedGear,
  onToggleGear,
}: AlpineScubaChecklistProps) {
      ...
      <div className="border-b border-zinc-200 pb-4 dark:border-zinc-800">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            >
              Mandatory Cold Water &amp; Ice Safety Checklist
            </h2>
          </div>
          <div
            data-testid="alpine-scuba-gear-counter"
        ...
        <p className="mt-2 text-base text-zinc-600 dark:text-zinc-400">
          Mandatory life-support equipment, redundant breathing systems, buoyant ice tethers, and trench cutting tools required for high-altitude cold-water and overhead ice diving expeditions.
        </p>
      </div>
